...
For a given set of LUs and a frame name, list all core FEs of the frame.
...
For a given set of LUs, a frame name, and a list of core FEs of the frame, write a definition that includes all core FEs of the frame and does not contain the word that names the frame itself, and give each FE definition - a description of the participant in the context of the situation that is denoted by the frame.
